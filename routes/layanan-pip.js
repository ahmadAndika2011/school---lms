...
router.get("/layanan/pip", checkAuth, checkRole("siswa"), controllers.getLayananPip)
router.post("/layanan/pip", checkAuth, checkRole("siswa"), upload.any(), controllers.postLayananPip)
